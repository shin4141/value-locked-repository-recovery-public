...
| --- | --- | --- |
| Install completion / truthful success | An incomplete R-package install cannot silently continue as if required packages are available | [`GuyTeichman/RNAlysis` PR #289 — MERGED](https://github.com/GuyTeichman/RNAlysis/pull/289) |
